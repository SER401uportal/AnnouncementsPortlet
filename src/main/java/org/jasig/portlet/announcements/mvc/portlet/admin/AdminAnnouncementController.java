...
public class AdminAnnouncementController implements InitializingBean {
  ...
  public static final String DEFAULT_TINY_MCE_INITIALIZATION_OPTIONS = "mode:\"textareas\", "
      + " editor_selector:\"mceEditor\", " + " theme:\"advanced\", " + " plugins:\"paste,preview\", "
  ...
  public void initBinder(WebDataBinder binder) {
    ...
    binder.setAllowedFields(new String[] { "id", "created", "author", "title", "abstractText", "message", "link",
        "startDisplay", "endDisplay", "parent", "action", "attachments" });
  }
  ...
  public String showAddAnnouncementForm(@RequestParam(value = "editId", required = false) Long editId,
    ...
    model.addAttribute("tinyMceInitializationOptions",
        prefs.getValue(PREFERENCE_TINY_MCE_INITIALIZATION_OPTIONS, DEFAULT_TINY_MCE_INITIALIZATION_OPTIONS));
   ...
   */
  @RequestMapping(params = "action=addAnnouncement")
  public void actionAddAnnouncementForm(@ModelAttribute("announcement") Announcement announcement, BindingResult result,
      SessionStatus status, ActionRequest req, ActionResponse res) throws PortletException {
  ...
  public void actionDeleteAnnouncement(@RequestParam("topicId") Long topicId, @RequestParam("annId") Long annId,
  ...
  public void setCustomDateFormat(String customDateFormat) {
    ...
    if (log.isDebugEnabled()) {
      log.debug("Custom date input format: [" + pieces[0] + " " + divider + " " + pieces[1] + " " + divider + " "
          + pieces[2] + "]");
    }
